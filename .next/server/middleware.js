...
async function middleware(req) {
    ...
    //未授权，跳转到登录页面
    if (!session) {
        return next_dist_server_web_exports_next_response__WEBPACK_IMPORTED_MODULE_0__/* ["default"].redirect */ .Z.redirect(new URL("/login", req.url));
    } else {
        next_dist_server_web_exports_next_response__WEBPACK_IMPORTED_MODULE_0__/* ["default"].next */ .Z.next();
    }
}
